class PostsController < ApplicationController
    ...
    def update
        ...
        :practice_timezone, :weather, :place, :kind_of_practice, 
        :strength, :content, :practice_day,
        post_records_attributes:[:distance_km, :distance_m, :time, :time_hour, :time_minute, :time_second, :record_type, :pace_minute, :pace_second, :pace_undersecond, :pace, :distance, :_destroy, :id]
        ).merge(user_id: current_user.id)
